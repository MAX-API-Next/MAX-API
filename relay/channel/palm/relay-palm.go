...
func palmStreamHandler(c *gin.Context, resp *http.Response) (*types.MaxAPIError, string) {
	responseText := ""
...
func palmHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.MaxAPIError) {
	responseBody, err := io.ReadAll(resp.Body)
	if err != nil {

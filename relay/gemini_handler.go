...
func GeminiHelper(c *gin.Context, info *relaycommon.RelayInfo) (maxAPIError *types.MaxAPIError) {
	...
	if model_setting.GetGeminiSettings().ThinkingAdapterEnabled {
		...
		if !model_setting.GetGlobalSettings().PassThroughRequestEnabled && !info.ChannelSetting.PassThroughBodyEnabled {
			if err := gemini.ThinkingAdaptor(c, request, info); err != nil {
...
func GeminiEmbeddingHandler(c *gin.Context, info *relaycommon.RelayInfo) (maxAPIError *types.MaxAPIError) {
	info.InitChannelMeta(c)

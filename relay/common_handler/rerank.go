...
import (
	...
	"github.com/MAX-API-Next/MAX-API/relay/channel/xinference"
...
func RerankHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.MaxAPIError) {

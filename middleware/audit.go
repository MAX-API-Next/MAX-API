...
var auditRouteActions = map[string]string{
	...
	"POST /api/system-task/log-cleanup": "log.clear",
}
...
func beginAdminAudit(c *gin.Context) *auditResponseWriter {
	...
	if common.GetContextKeyBool(c, constant.ContextKeyAuditWrapped) {
		return nil
	}
	common.SetContextKey(c, constant.ContextKeyAuditWrapped, true)

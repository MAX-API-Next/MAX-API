        ...
        <SettingsForm onSubmit={form.handleSubmit(onSubmit)} autoComplete='off'>
          ...
          <div className='grid gap-6 md:grid-cols-2'>
            ...
            <FormItem>
              ...
              <FormDescription>
                {t(
                  'Automatic mode upgrades with STARTTLS when available; STARTTLS mode requires server support'
                )}
              </FormDescription>
            </FormItem>
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    autoComplete='off'
                    placeholder={t('MAX API &lt;noreply@example.com&gt;')}
                    {...field}
                    onChange={(event) => field.onChange(event.target.value)}
                  />
                </FormControl>

# MAX API Electron Desktop App

This directory contains the Electron wrapper for MAX API, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., max-api-macos)
cp ../max-api-macos ../max-api
```
...
- Store database in `../data/max-api.db`
...
### Database Location
- **Development**: `../data/max-api.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/MAX API/data/`
  - Windows: `%APPDATA%/MAX API/data/`
  - Linux: `~/.config/MAX API/data/`
